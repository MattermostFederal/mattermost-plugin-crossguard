...
Where `<plan-file>` is the path passed as the first argument (e.g., `implementation-plans/26-02-22-1200-dynamic-demo-ato-timestamps.md`).
...
6. **Slash command**: If the plan adds new admin-facing functionality, does it consider a `/aoc` subcommand? (See `server/CLAUDE.md` → Slash Commands)
